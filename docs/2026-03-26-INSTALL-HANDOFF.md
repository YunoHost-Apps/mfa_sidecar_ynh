...
- installer-facing branch: `github-package`
- current `main` tip at handoff time: `d67da0f` — `Strip service units down for alpha host compatibility`
- current `github-package` tip at handoff time: `35d7fec` — `Refresh published package root after unit simplification`
