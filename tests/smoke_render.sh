...
grep -q "location = /authelia-auth-root_site" "$OUT_DIR/nginx/root_site.generated.conf"
grep -q "proxy_pass http://127.0.0.1:9091/api/authz/auth-request" "$OUT_DIR/nginx/root_site.generated.conf"
